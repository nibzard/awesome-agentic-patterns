...
Build small pattern sets around a concrete use case so you can test how combinations behave before scaling them up.

## Next Steps

- Use the [Decision Tree](/decision) to find patterns
- Build a shortlist of complementary patterns for your specific use case
